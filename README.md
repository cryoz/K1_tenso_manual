...
Необходимо собрать новые прошивки для модуля стола, головы и основной платы. Либо собираем самостоятельно - либо скачиваем [отсюда](./outfw)
...
Поправить настройки тенз в файле `/usr/data/printer_data/config/loadcell_probe.cfg` взяв нужные пины из слота в который воткнули перепаянную тензу из этой картинки:
![alt text](pics/slots_and_pins.jpg)
